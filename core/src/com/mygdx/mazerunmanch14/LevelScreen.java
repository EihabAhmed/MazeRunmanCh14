...
public class LevelScreen extends BaseScreen {
    ...
    public void initialize() {
        ...
        for (BaseActor room : BaseActor.getList(mainStage, "com.mygdx.mazerunmanch14.Room")) {
    ...
    public void update(float dt) {
        ...
        for (BaseActor coin : BaseActor.getList(mainStage, "com.mygdx.mazerunmanch14.Coin")) {
        ...
        int coins = BaseActor.getList(mainStage, "com.mygdx.mazerunmanch14.Coin").size();
